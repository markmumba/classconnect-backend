# Generated by Django 5.2.3 on 2025-06-22 09:50
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('student', 'student'), ('teacher', 'teacher'), ('admin', 'School Admin'), ('super_admin', 'Super Admin')], default='student', max_length=20)),
                ...
                ('sub_school', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='users', to='schools.subschool')),
